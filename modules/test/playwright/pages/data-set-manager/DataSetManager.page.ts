...
export class DataSetManagerPage {
	...
	constructor(page) {
        ...
        this.ADD_FIELDS_BUTTON = this.page.getByRole('button', {name: 'Add Fields'});
        this.ADD_FIELDS_MODAL_TITLE = this.page.getByRole('heading', {name: 'Add Fields'});
        this.ADD_ITEM_ACTION = this.page.getByRole('button', {name: 'New Item Action'});
	}
    ...
    async deleteDataSet({name = 'Data Set test'}: {name?: string} = {}) {
        ...
        await datasetTestRow.first().getByRole('button', {name: 'Actions'}).click();
	...
	async createTestDataSetView({dataSetName = 'Data Set Test'}: {dataSetName?: string} = {}) {
	...
	async gotoTestDataSetView({dataSetName = 'Data Set Test'}: {dataSetName?: string} = {}) {
        await this.gotoTestDataSet({name: dataSetName});
