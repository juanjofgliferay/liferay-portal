...
@Generated("")
@GraphQLName(
	description = "A fragment image viewport.", value = "FragmentImageViewport"
)
@io.swagger.v3.oas.annotations.media.Schema(
	description = "A fragment image viewport.",
	requiredProperties = {"id", "resolution"}
)
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "FragmentImageViewport")
public class FragmentImageViewport implements Serializable {

	public static FragmentImageViewport toDTO(String json) {
		return ObjectMapperUtil.readValue(FragmentImageViewport.class, json);
	}

	public static FragmentImageViewport unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(
			FragmentImageViewport.class, json);
	}

	@io.swagger.v3.oas.annotations.media.Schema(
		description = "The fragment image viewport's ID."
	)
	@JsonGetter("id")
	@Valid
	public Id getId() {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FragmentImageViewport",
		name = "x-class-name"
	)
