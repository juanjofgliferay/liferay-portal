...
public class FormStepContainerPageElementDefinition
	...
	public static FormStepContainerPageElementDefinition toDTO(String json) {
		return ObjectMapperUtil.readValue(
			FormStepContainerPageElementDefinition.class, json);
	}

	public static FormStepContainerPageElementDefinition unsafeToDTO(
		String json) {
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.liferay.headless.admin.site.dto.v1_0.FormStepContainerPageElementDefinition",
		name = "x-class-name"
	)
